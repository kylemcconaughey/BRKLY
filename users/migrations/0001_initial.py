    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name_is_public', models.BooleanField(default=False)),
                ('num_pets', models.IntegerField(blank=True, default=0, null=True)),
                ('street_address', models.CharField(blank=True, max_length=255, null=True)),
                ('address_is_public', models.BooleanField(default=False)),
                ...
                ('birthdate_is_public', models.BooleanField(default=False)),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='post_images/')),
